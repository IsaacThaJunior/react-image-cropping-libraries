      ...
      <main>
        <section className="mt-8">
          <div className="flex justify-center">
            ...
            <article className="mx-2">
              <Checkbox
                label="React Advanced Cropper"
                isChecked={selectedModal === "React Advanced Cropper"}
                onChange={setSelectedModal}
                id="r-advaned-cropper"
              />
            </article>
						
            <article className="mx-2">
              <Checkbox
                label="React Perspective Cropper"
                isChecked={selectedModal === "React Perspective Cropper"}
                onChange={setSelectedModal}
                id="r-perspective-cropper"
              />
            </article>
          </div>
